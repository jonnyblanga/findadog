...
dog = Dog.new(name: "Joey", gender: "male", date_of_birth: "2017-01-02", size: "small", breed: "Norrbottenspets", color: ["white", "beige"], is_hypoallergenic: "false", is_sterilized: "true", user_id: User.all.first.id)
...
dog = Dog.new(name: "Jamie", gender: "female", date_of_birth: "2017-12-15", size: "small", breed: "Norrbottenspets", color: ["white", "beige"], is_hypoallergenic: "false", is_sterilized: "false", user_id: User.all.first.id)
dog.remote_photo_url = "https://www.101dogbreeds.com/wp-content/uploads/2016/12/Norrbottenspets.jpg"
dog.save

dog = Dog.new(name: "Nancy", gender: "female", date_of_birth: "2014-06-11", size: "medium", breed: "Old English Sheepdog", color: ["white", "gray"], is_hypoallergenic: "false", is_sterilized: "true", user_id: User.all.first.id)
dog.remote_photo_url = "https://i.pinimg.com/originals/f5/66/52/f5665206ab52eafa4ad2d65141024eda.jpg"
dog.save

dog = Dog.new(name: "Shirley", gender: "female", date_of_birth: "2017-12-15", size: "medium", breed: "Old English Sheepdog", color: ["white", "gray"], is_hypoallergenic: "false", is_sterilized: "false", user_id: User.all.first.id)
dog.remote_photo_url = "http://elelur.com/data_images/dog-breeds/old-english-sheepdog/old-english-sheepdog-08.jpg"
dog.save

dog = Dog.new(name: "Spot", gender: "male", date_of_birth: "2014-03-24", size: "small", breed: "Parson Russell Terrier", color: ["brown", "white"], is_hypoallergenic: "false", is_sterilized: "false", user_id: User.all.first.id)
...
dog = Dog.new(name: "Reece", gender: "male", date_of_birth: "2015-06-20", size: "small", breed: "Parson Russell Terrier", color: ["brown", "white"], is_hypoallergenic: "true", is_sterilized: "false", user_id: User.all.first.id)
...
dog = Dog.new(name: "Shaniqua", gender: "female", date_of_birth: "2017-04-20", size: "small", breed: "Pomeranian", color: ["white"], is_hypoallergenic: "false", is_sterilized: "false", user_id: User.all.first.id)
dog.remote_photo_url = "https://dogbreedatlas.com/images/dog-breed-photos/pomeranian/001/pomeranian-1490682869-1.jpg"
dog.save

dog = Dog.new(name: "Floof", gender: "female", date_of_birth: "2018-01-30", size: "small", breed: "Pomeranian", color: ["brown", "orange", "white"], is_hypoallergenic: "false", is_sterilized: "false", user_id: User.all.first.id)
dog.remote_photo_url = "https://s3.us-west-2.amazonaws.com/photos.puppyspot.com/breeds/238/card/500000283_medium.jpg"
dog.save

dog = Dog.new(name: "Hercules", gender: "male", date_of_birth: "2016-08-03", size: "large", breed: "Rottweiler", color: ["brown", "black"], is_hypoallergenic: "false", is_sterilized: "false", user_id: User.all.first.id)
...
dog = Dog.new(name: "Buster", gender: "male", date_of_birth: "2015-03-01", size: "medium", breed: "Beagle", color: ["black", "white", "brown"], is_hypoallergenic: "false", is_sterilized: "false", user_id: 14)
dog.remote_photo_url = "http://www.breedog.it/wp-content/uploads/2015/12/Beagle.jpg"
dog.save

dog = Dog.new(name: "Oliver", gender: "male", date_of_birth: "2018-01-23", size: "medium", breed: "Beagle", color: ["black", "white", "brown"], is_hypoallergenic: "false", is_sterilized: "false", user_id: 15)
dog.remote_photo_url = "https://4.bp.blogspot.com/-OAAuZwm0Bpo/Vjd1u9uARRI/AAAAAAAF0HU/5lCKvn1bkNU/s1600/beagle.jpg"
dog.save

dog = Dog.new(name: "Rocky", gender: "male", date_of_birth: "2013-04-11", size: "small", breed: "French Bulldog", color: ["beige"], is_hypoallergenic: "false", is_sterilized: "false", user_id: 16)
dog.remote_photo_url = "https://www.pets4homes.co.uk/images/breeds/56/9b8f8158056fc5420a03372c9772678e.jpeg"
dog.save

dog = Dog.new(name: "Gus", gender: "male", date_of_birth: "2016-12-06", size: "small", breed: "French Bulldog", color: ["white", "black"], is_hypoallergenic: "false", is_sterilized: "false", user_id: 16)
...
dog = Dog.new(name: "Luna", gender: "female", date_of_birth: "2013-11-20", size: "large", breed: "Dalmatian", color: ["white", "black"], is_hypoallergenic: "false", is_sterilized: "true", user_id: 14)
dog.remote_photo_url = "https://www.barinedita.it/public/foto_galleria/dalmata_7.jpg"
dog.save

dog = Dog.new(name: "Bear", gender: "male", date_of_birth: "2011-12-19", size: "large", breed: "German Sheperd", color: ["black", "brown"], is_hypoallergenic: "false", is_sterilized: "false", user_id: 15)
...
dog = Dog.new(name: "Jack", gender: "male", date_of_birth: "2014-09-11", size: "large", breed: "German Sheperd", color: ["black", "brown"], is_hypoallergenic: "false", is_sterilized: "true", user_id: 15)
...
dog = Dog.new(name: "Bailey", gender: "female", date_of_birth: "2013-10-03", size: "large", breed: "Labrador", color: ["beige"], is_hypoallergenic: "false", is_sterilized: "true", user_id: 14)
...
dog = Dog.new(name: "Maggie", gender: "female", date_of_birth: "2010-12-23", size: "large", breed: "Labrador", color: ["white"], is_hypoallergenic: "false", is_sterilized: "false", user_id: 15)
...
dog = Dog.new(name: "Loop", gender: "female", date_of_birth: "2011-04-23", size: "large", breed: "Labrador", color: ["white"], is_hypoallergenic: "false", is_sterilized: "false", user_id: 16)
...
dog = Dog.new(name: "Maya", gender: "female", date_of_birth: "2015-01-17", size: "small", breed: "Dachshund", color: ["black"], is_hypoallergenic: "false", is_sterilized: "true", user_id: 12)
dog.remote_photo_url = "https://www.pets4homes.co.uk/images/breeds/57/large/ca02f0e6d0cc2bfa187de33b9565b61e.JPG"
dog.save

dog = Dog.new(name: "Daisy", gender: "female", date_of_birth: "2013-11-10", size: "small", breed: "Dachshund", color: ["brown"], is_hypoallergenic: "false", is_sterilized: "false", user_id: 12)
...
dog = Dog.new(name: "Max", gender: "male", date_of_birth: "2012-04-25", size: "large", breed: "Doberman", color: ["black", "brown"], is_hypoallergenic: "false", is_sterilized: "false", user_id: 14)
...
dog = Dog.new(name: "Duke", gender: "male", date_of_birth: "2013-03-09", size: "large", breed: "Doberman", color: ["black", "brown"], is_hypoallergenic: "false", is_sterilized: "false", user_id: 15)
...
dog = Dog.new(name: "Bella", gender: "female", date_of_birth: "2018-12-19", size: "small", breed: "Chihuahua", color: ["white", "beige"], is_hypoallergenic: "false", is_sterilized: "false", user_id: 14)
dog.remote_photo_url = "https://http2.mlstatic.com/chihuahua-cachorro-macho-D_NQ_NP_683900-MLA27566558302_062018-F.jpg"
dog.save

dog = Dog.new(name: "Greg", gender: "male", date_of_birth: "2018-10-29", size: "small", breed: "Bulldog", color: ["white", "golden"], is_hypoallergenic: "false", is_sterilized: "false", user_id: User.all.first.id)
dog.remote_photo_url = "https://irp-cdn.multiscreensite.com/a123db97/dms3rep/multi/IMG_3571-03-08-17-05-55.JPG"
dog.save

dog = Dog.new(name: "Augie", gender: "male", date_of_birth: "2015-07-12", size: "small", breed: "Bulldog", color: ["white", "beige"], is_hypoallergenic: "false", is_sterilized: "false", user_id: User.all.first.id)
dog.remote_photo_url = "https://www.pets4homes.co.uk/images/breeds/56/9b8f8158056fc5420a03372c9772678e.jpeg"
dog.save

puts 'Creating fake messages...'

Message.create( context: "Hello I'm interested in adopting a golden retriever from your shelter",  from_user_id: 1,  to_user_id: User.all.first.id)
Message.create( context: "That is great, he is a very good dog",  from_user_id: 2,  to_user_id: 1)
Message.create( context: "wow that’s amazing",  from_user_id: 1,  to_user_id: User.all.first.id)
Message.create( context: "Does the dog have all of his vaccine shots, I saw on the dog card that it specified that he in fact has gotten vaccine shots but I am asking just to be sure. Even if he doesn’t have vaccine shots I would love to adopt him",  from_user_id: 1,  to_user_id: User.all.first.id)
...
Message.create( context: "Yes I would love to arrive tomorrow at 1 to see the dog and hopefully adopt him and I love paperwork",  from_user_id: 1,  to_user_id: User.all.first.id)
Message.create( context: "I am not allergic to the dog so it shouldn’t be a problem",  from_user_id: 1,  to_user_id: User.all.first.id)
Message.create( context: "wow this website is amazing so many people adopt dogs through this",  from_user_id: 2,  to_user_id:1)
Message.create( context: "Yes wow such an amazing website I agree",  from_user_id: 1,  to_user_id: User.all.first.id)
Message.create( context: "Can you send me your whatsapp number so we can chat over the phone a bit.",  from_user_id: 1,  to_user_id: User.all.first.id)
...
Message.create( context: "wow you are right, they are so amazing, I will call you soon and maybe we could video chat so I can see the dog",  from_user_id: 1,  to_user_id: User.all.first.id)
Message.create( context:  "yes great idea, so hear from you soon",  from_user_id: 2,  to_user_id:1)
Message.create( context: "yes I’m going to call you soon hear from you then",  from_user_id: 1,  to_user_id: User.all.first.id)
