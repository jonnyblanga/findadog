...
dog = dog = Dog.new(name: "Joey", gender: "male", date_of_birth: "2017-01-02", size: "small", breed: "Norrbottenspets", color: "white beige", is_hypoallergenic: "", is_sterilized: "true", user_id: 2)
dog.remote_photo_url = "https://www.101dogbreeds.com/wp-content/uploads/2016/12/Norrbottenspets-Pictures.jpg"
dog.pictures[0].remote_photo_url = "http://skadi.se/wp-content/uploads/2015/04/agnar11.jpg"
dog.pictures[1].remote_photo_url = "https://upload.wikimedia.org/wikipedia/en/7/7b/Norrbottenspets_Karina_2008.jpg"
dog.save

dog = Dog.new(name: "Jamie", gender: "female", date_of_birth: "2017-12-15", size: "small", breed: "Norrbottenspets", color: "white beige", is_hypoallergenic: "", is_sterilized: "false", user_id: 2)
dog.remote_photo_url = "https://www.101dogbreeds.com/wp-content/uploads/2016/12/Norrbottenspets.jpg"
dog.save

dog = Dog.new(name: "Nancy", gender: "female", date_of_birth: "2014-06-11", size: "medium", breed: "Old English Sheepdog", color: "white gray", is_hypoallergenic: "", is_sterilized: "true", user_id: 2)
dog.remote_photo_url = "https://i.pinimg.com/originals/f5/66/52/f5665206ab52eafa4ad2d65141024eda.jpg"
dog.save

dog = Dog.new(name: "Shirley", gender: "female", date_of_birth: "2017-12-15", size: "medium", breed: "Old English Sheepdog", color: "white gray", is_hypoallergenic: "", is_sterilized: "false", user_id: 2)
dog.remote_photo_url = "http://elelur.com/data_images/dog-breeds/old-english-sheepdog/old-english-sheepdog-08.jpg"
dog.save

dog = Dog.new(name: "Spot", gender: "male", date_of_birth: "2014-03-24", size: "small", breed: "Parson Russell Terrier", color: "brown white", is_hypoallergenic: "false", is_sterilized: "", user_id: 2)
...
dog = Dog.new(name: "Reece", gender: "male", date_of_birth: "2015-06-20", size: "small", breed: "Parson Russell Terrier", color: "brown white", is_hypoallergenic: "true", is_sterilized: "", user_id: 2)
...
dog = Dog.new(name: "Shaniqua", gender: "female", date_of_birth: "2017-04-20", size: "small", breed: "Pomeranian", color: "white", is_hypoallergenic: "", is_sterilized: "false", user_id: 2)
dog.remote_photo_url = "https://dogbreedatlas.com/images/dog-breed-photos/pomeranian/001/pomeranian-1490682869-1.jpg"
dog.save

dog = Dog.new(name: "Floof", gender: "female", date_of_birth: "2018-01-30", size: "small", breed: "Pomeranian", color: "brown orange white", is_hypoallergenic: "", is_sterilized: "", user_id: 2)
dog.remote_photo_url = "https://s3.us-west-2.amazonaws.com/photos.puppyspot.com/breeds/238/card/500000283_medium.jpg"
dog.save

dog = Dog.new(name: "Hercules", gender: "male", date_of_birth: "2016-08-03", size: "large", breed: "Rottweiler", color: "brown black", is_hypoallergenic: "", is_sterilized: "", user_id: 2)
dog.remote_photo_url = "https://i.pinimg.com/736x/02/8e/17/028e17e5baace88a8f2da2ff19332849.jpg"
dog.save

dog = Dog.new(name: "Lucy", gender: "female", date_of_birth: "2016-08-03", size: "large", breed: "Rottweiler", color: "brown black", is_hypoallergenic: "", is_sterilized: "", user_id: 13)
dog.remote_photo_url = "https://s3.amazonaws.com/imagesroot.rescuegroups.org/webpages/s5952nqw9wv2oeyx.jpg"
dog.save

dog = Dog.new(name: "Jack", gender: "male", date_of_birth: "2011-05-03", size: "small", breed: "Russell Terrier", color: "brown white", is_hypoallergenic: "", is_sterilized: "", user_id: 13)
dog.remote_photo_url = "https://jrtrescue.net/wp-content/uploads/2017/01/Buddy-Happy-adoption-story-1024x768.jpg"
dog.save

dog = Dog.new(name: "Molly", gender: "female", date_of_birth: "2016-11-26", size: "large", breed: "Akita", color: "beige white", is_hypoallergenic: "", is_sterilized: "true", user_id: 13)
dog.remote_photo_url = "https://doctorvetblog.files.wordpress.com/2016/07/happy-akita-inu-dog-wallpaper.jpg"
dog.save

dog = Dog.new(name: "Buster", gender: "male", date_of_birth: "2015-03-01", size: "medium", breed: "Beagle", color: "black white brown", is_hypoallergenic: "", is_sterilized: "false", user_id: 14)
dog.remote_photo_url = "http://www.breedog.it/wp-content/uploads/2015/12/Beagle.jpg"
dog.save

dog = Dog.new(name: "Oliver", gender: "male", date_of_birth: "2018-01-23", size: "medium", breed: "Beagle", color: "black white brown", is_hypoallergenic: "", is_sterilized: "false", user_id: 15)
dog.remote_photo_url = "https://4.bp.blogspot.com/-OAAuZwm0Bpo/Vjd1u9uARRI/AAAAAAAF0HU/5lCKvn1bkNU/s1600/beagle.jpg"
dog.save

dog = Dog.new(name: "Rocky", gender: "male", date_of_birth: "2013-04-11", size: "small", breed: "French Bulldog", color: "beige", is_hypoallergenic: "", is_sterilized: "false", user_id: 16)
dog.remote_photo_url = "https://www.pets4homes.co.uk/images/breeds/56/9b8f8158056fc5420a03372c9772678e.jpeg"
dog.save

dog = Dog.new(name: "Gus", gender: "male", date_of_birth: "2016-12-06", size: "small", breed: "French Bulldog", color: "white black", is_hypoallergenic: "", is_sterilized: "false", user_id: 16)
...
dog = Dog.new(name: "Tucker", gender: "male", date_of_birth: "2010-04-24", size: "large", breed: "Dalmatian", color: "white black", is_hypoallergenic: "", is_sterilized: "false", user_id: 13)
dog.remote_photo_url = "https://quattrozampe.online/wp-content/uploads/2018/10/dalmata-3-960x662.jpg"
dog.save

dog = Dog.new(name: "Luna", gender: "female", date_of_birth: "2013-11-20", size: "large", breed: "Dalmatian", color: "white black", is_hypoallergenic: "", is_sterilized: "true", user_id: 14)
dog.remote_photo_url = "https://www.barinedita.it/public/foto_galleria/dalmata_7.jpg"
dog.save

dog = Dog.new(name: "Bear", gender: "male", date_of_birth: "2011-12-19", size: "large", breed: "German Sheperd", color: "black brown", is_hypoallergenic: "", is_sterilized: "false", user_id: 15)
...
dog = Dog.new(name: "Jack", gender: "male", date_of_birth: "2014-09-11", size: "large", breed: "German Sheperd", color: "black brown", is_hypoallergenic: "", is_sterilized: "true", user_id: 15)
...
dog = Dog.new(name: "Sadie", gender: "female", date_of_birth: "2015-01-03", size: "large", breed: "German Sheperd", color: "black brown", is_hypoallergenic: "", is_sterilized: "false", user_id: 13)
...
dog = Dog.new(name: "Bailey", gender: "female", date_of_birth: "2013-10-03", size: "large", breed: "Labrador", color: "beige", is_hypoallergenic: "", is_sterilized: "true", user_id: 14)
...
dog = Dog.new(name: "Maggie", gender: "female", date_of_birth: "2010-12-23", size: "large", breed: "Labrador", color: "white", is_hypoallergenic: "", is_sterilized: "false", user_id: 15)
...
dog = Dog.new(name: "Lola", gender: "female", date_of_birth: "2011-04-23", size: "large", breed: "Labrador", color: "white", is_hypoallergenic: "", is_sterilized: "false", user_id: 16)
...
dog = Dog.new(name: "Buddy", gender: "male", date_of_birth: "2014-04-23", size: "large", breed: "Labrador", color: "beige", is_hypoallergenic: "", is_sterilized: "false", user_id: 13)
dog.remote_photo_url = "http://4.bp.blogspot.com/-2gg6M-dHfJU/Tg-fDZY5r1I/AAAAAAAALlM/v2IcgysOHKU/s1600/2976.jpg"
dog.save

dog = Dog.new(name: "Lexy", gender: "female", date_of_birth: "2010-10-10", size: "small", breed: "Maltese", color: "white", is_hypoallergenic: "", is_sterilized: "true", user_id: 13)
dog.remote_photo_url = "https://bepuppyblog-4fef.kxcdn.com/wp-content/uploads/2017/04/cane-maltese.jpg"
dog.save

dog = Dog.new(name: "Maya", gender: "female", date_of_birth: "2015-01-17", size: "small", breed: "Dachshund", color: "black", is_hypoallergenic: "", is_sterilized: "true", user_id: 12)
dog.remote_photo_url = "https://www.pets4homes.co.uk/images/breeds/57/large/ca02f0e6d0cc2bfa187de33b9565b61e.JPG"
dog.save

dog = Dog.new(name: "Daisy", gender: "female", date_of_birth: "2013-11-10", size: "small", breed: "Dachshund", color: "brown", is_hypoallergenic: "", is_sterilized: "false", user_id: 12)
dog.remote_photo_url = "https://ncvs.net.au/wp-content/uploads/dachsund.jpg"
dog.save

dog = Dog.new(name: "Cooper", gender: "male", date_of_birth: "2016-12-28", size: "small", breed: "Dachshund", color: "black brown", is_hypoallergenic: "", is_sterilized: "false", user_id: 13)
dog.remote_photo_url = "https://storage.googleapis.com/nom-nom-now/images/breeds/dachshund.jpg"
dog.save

dog = Dog.new(name: "Max", gender: "male", date_of_birth: "2012-04-25", size: "large", breed: "Doberman", color: "black brown", is_hypoallergenic: "", is_sterilized: "false", user_id: 14)
...
dog = Dog.new(name: "Duke", gender: "male", date_of_birth: "2013-03-09", size: "large", breed: "Doberman", color: "black brown", is_hypoallergenic: "", is_sterilized: "false", user_id: 15)
...
dog = Dog.new(name: "Lola", gender: "female", date_of_birth: "2017-08-09", size: "small", breed: "Chihuahua", color: "black beige", is_hypoallergenic: "", is_sterilized: "false", user_id: 13)
dog.remote_photo_url = "https://www.dogster.com/wp-content/uploads/2015/05/shutterstock_1741426311.jpg"
dog.save

dog = Dog.new(name: "Bella", gender: "female", date_of_birth: "2018-12-19", size: "small", breed: "Chihuahua", color: "white beige", is_hypoallergenic: "", is_sterilized: "false", user_id: 14)
dog.remote_photo_url = "https://http2.mlstatic.com/chihuahua-cachorro-macho-D_NQ_NP_683900-MLA27566558302_062018-F.jpg"
dog.save

dog = Dog.new(name: "Greg", gender: "male", date_of_birth: "2018-10-29", size: "small", breed: "Bulldog", color: "white gold", is_hypoallergenic: "", is_sterilized: "false", user_id: 2)
dog.remote_photo_url = "https://irp-cdn.multiscreensite.com/a123db97/dms3rep/multi/IMG_3571-03-08-17-05-55.JPG"
dog.save

dog = Dog.new(name: "Augie", gender: "male", date_of_birth: "2015-07-12", size: "small", breed: "Bulldog", color: "white beige", is_hypoallergenic: "", is_sterilized: "false", user_id: 2)
dog.remote_photo_url = "https://www.pets4homes.co.uk/images/breeds/56/9b8f8158056fc5420a03372c9772678e.jpeg"
dog.save
